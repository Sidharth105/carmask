...
dataset_train.load_data(r"C:\Users\sidha\Desktop\model\dataset\train\train.json", r"C:\Users\sidha\Desktop\model\dataset\train")
dataset_train.prepare()

#In this example, I do not have annotations for my validation data, so I am loading train data
dataset_val = CocoLikeDataset()
dataset_val.load_data(r"C:\Users\sidha\Desktop\model\dataset\valid\valid.json", r"C:\Users\sidha\Desktop\model\dataset\valid")
dataset_val.prepare()
...
ROOT_DIR = os.path.abspath(r"C:\Users\sidha\Desktop\model")
# Import Mask RCNN
sys.path.append(ROOT_DIR)  # To find local version of the library
# Directory to save logs and trained model
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "logs")
# Path to trained weights file
COCO_WEIGHTS_PATH = r"C:\Users\sidha\Desktop\model\mask_rcnn_coco.h5"
